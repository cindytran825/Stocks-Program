...
public class BarChartTest {
  ...
  public void testChartMonth() {
    ...
    assertEquals("Performance of Stock/Portfolio " +
            "cindy from 2024-02-03 to 2024-06-28\n" +
            "FEB 2024: ******\n" +
            "MAR 2024: *******\n" +
            "APR 2024: ********\n" +
            "MAY 2024: ********\n" +
  ...
  public void testGetBarChart() {
    List<Double> listOfValues = new ArrayList<>(Arrays.asList(23000.0,
    ...
    //getBarChart(MyDate firstDate, String decide, List<String> listOfDates,
    // List<Double> listOfValues)
    assertEquals("Performance of Stock/Portfolio cindy" +
            " from 2014-09-15 to 2014-09-14\n" +
            "APR 2014: ***********************\n" +
            "MAY 2014: *********************************\n" +
            "JUN 2014: *******************************************\n" +
            "JUL 2014: *********************************\n" +
            "AUG 2014: *******************************************\n" +
            "Scale: * = 1000", data.getBarChart(firstDate,
            "month", listOfDates, listOfValues));
  }
  ...
  public void testGetBarChartYears() {
    List<Double> listOfValues = new ArrayList<>(Arrays.asList(15000.0,
            33000.0, 63000.0, 33000.0, 74000.0, 70000.0));
    ...
    assertEquals("Performance of Stock/Portfolio cindy " +
            ...
            "DEC 2018: ********\n" +
            "AUG 2019: *******\n" +
            "Scale: * = 10000", barChartWithImpl.getBarChart(firstDate,
            "month", listOfDates, listOfValues));
  }
  ...
  public void testGetBarStock2Months() {
    BarChartWithImpl data = new BarChartWithImpl("cindy",
            ...
            goog, testFolderPath);
    assertEquals("Performance of Stock/Portfolio " +
            "cindy from 2014-05-16 to 2014-07-20\n" +
            "APR 2014: \n" +
            "JUN 2014: \n" +
            "MAY 2014: ******\n" +
            "JUL 2014: ******\n" +
